...
var G__25729 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__25729;
continue;
} else {
return ch;
...
var vec__25730 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__25730,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq25733){
...
return (function() { 
var G__25738__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__25738 = function (rdr,var_args){
var _ = null;
...
return G__25738__delegate.call(this,rdr,_);};
G__25738.cljs$lang$maxFixedArity = 1;
...
return G__25738__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1530911822162
