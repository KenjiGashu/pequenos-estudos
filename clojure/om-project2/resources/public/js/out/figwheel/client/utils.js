...
return (new CustomEvent(event_name,(function (){var obj29392 = {"detail":data};
return obj29392;
})()));
} else {
...
var f = (function (){var pred__29399 = cljs.core._EQ_;
var expr__29400 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29399.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29400))){
return ((function (pred__29399,expr__29400){
return (function (p1__29393_SHARP_){
return console.warn(p1__29393_SHARP_);
});
;})(pred__29399,expr__29400))
} else {
if(cljs.core.truth_(pred__29399.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29400))){
return ((function (pred__29399,expr__29400){
return (function (p1__29394_SHARP_){
return console.debug(p1__29394_SHARP_);
});
;})(pred__29399,expr__29400))
} else {
if(cljs.core.truth_(pred__29399.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29400))){
return ((function (pred__29399,expr__29400){
return (function (p1__29395_SHARP_){
return console.error(p1__29395_SHARP_);
});
;})(pred__29399,expr__29400))
} else {
return ((function (pred__29399,expr__29400){
return (function (p1__29396_SHARP_){
return console.log(p1__29396_SHARP_);
});
;})(pred__29399,expr__29400))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29403){
...
var eval_fn = cljs.core.get.call(null,map__29404__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29406_SHARP_);
});})(new_def))
);
...
return (function (p__29407){
var vec__29408 = p__29407;
var ky = cljs.core.nth.call(null,vec__29408,(0),null);
var v = cljs.core.nth.call(null,vec__29408,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1530911824888
