...
return (new CustomEvent(event_name,(function (){var obj29391 = {"detail":data};
return obj29391;
})()));
} else {
...
var f = (function (){var pred__29398 = cljs.core._EQ_;
var expr__29399 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29398.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29399))){
return ((function (pred__29398,expr__29399){
return (function (p1__29392_SHARP_){
return console.warn(p1__29392_SHARP_);
});
;})(pred__29398,expr__29399))
} else {
if(cljs.core.truth_(pred__29398.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29399))){
return ((function (pred__29398,expr__29399){
return (function (p1__29393_SHARP_){
return console.debug(p1__29393_SHARP_);
});
;})(pred__29398,expr__29399))
} else {
if(cljs.core.truth_(pred__29398.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29399))){
return ((function (pred__29398,expr__29399){
return (function (p1__29394_SHARP_){
return console.error(p1__29394_SHARP_);
});
;})(pred__29398,expr__29399))
} else {
return ((function (pred__29398,expr__29399){
return (function (p1__29395_SHARP_){
return console.log(p1__29395_SHARP_);
});
;})(pred__29398,expr__29399))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29402){
var map__29403 = p__29402;
var map__29403__$1 = ((((!((map__29403 == null)))?(((((map__29403.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29403.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29403):map__29403);
var opts = map__29403__$1;
var eval_fn = cljs.core.get.call(null,map__29403__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29405_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29407,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1530901592919
