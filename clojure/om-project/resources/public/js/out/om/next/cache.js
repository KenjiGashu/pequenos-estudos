...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__21739 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__21740 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__21740,x_SINGLEQUOTE__21739,this$){
return (function (p1__21738_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__21738_SHARP_,id_SINGLEQUOTE__21740),id,x_SINGLEQUOTE__21739);
});})(id_SINGLEQUOTE__21740,x_SINGLEQUOTE__21739,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__21739);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__4192__auto__,writer__4193__auto__,opt__4194__auto__){
return cljs.core._write.call(null,writer__4193__auto__,"om.next.cache/Cache");
});

/**
 * Positional factory function for om.next.cache/Cache.
 */
...
//# sourceMappingURL=cache.js.map?rel=1530901583372
