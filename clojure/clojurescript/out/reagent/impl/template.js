...
var G__942 = o;
(G__942[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__946 = o;
(G__946[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__947__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__947 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__947__delegate.call(this,args);};
G__947.cljs$lang$maxFixedArity = 0;
G__947.cljs$lang$applyTo = (function (arglist__949){
var args = cljs.core.seq(arglist__949);
return G__947__delegate(args);
});
G__947.cljs$core$IFn$_invoke$arity$variadic = G__947__delegate;
return G__947;
})()
;
} else {
...
var G__951 = props;
var G__951__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__951,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__951);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__951__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__952){
var map__953 = p__952;
...
var props = map__953__$1;
var class$ = cljs.core.get.call(null,map__953__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__953,map__953__$1,props,class$){
return (function (c){
...
});})(map__953,map__953__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__955){
var map__956 = p__955;
...
var on_write = cljs.core.get.call(null,map__956__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__956,map__956__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__956,map__956__$1,on_write))
);
} else {
...
var G__959 = jsprops;
(G__959["defaultValue"] = value);

(G__959["onChange"] = ((function (G__959,v,value,on_change){
return (function (p1__958_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__958_SHARP_);
});})(G__959,v,value,on_change))
);
...
var vec__962 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__962,(0),null);
var id = cljs.core.nth.call(null,vec__962,(1),null);
var class$ = cljs.core.nth.call(null,vec__962,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___966 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___966 == null)){
} else {
var key_967 = temp__5461__auto___966;
(jsprops["key"] = key_967);
}
...
var temp__5461__auto___968 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___968 == null)){
} else {
var key_969 = temp__5461__auto___968;
reagent.impl.template.oset.call(null,jsprops,"key",key_969);
}
...
var G__970 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__970["name"] = c);
...
var len__4531__auto___975 = arguments.length;
var i__4532__auto___976 = (0);
while(true){
if((i__4532__auto___976 < len__4531__auto___975)){
args__4534__auto__.push((arguments[i__4532__auto___976]));

var G__977 = (i__4532__auto___976 + (1));
i__4532__auto___976 = G__977;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq973){
var G__974 = cljs.core.first.call(null,seq973);
var seq973__$1 = cljs.core.next.call(null,seq973);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__974,seq973__$1);
});
...
break;
default:
var G__980 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__980;
continue;
...
var n__4408__auto___982 = a.length;
var i_983 = (0);
while(true){
if((i_983 < n__4408__auto___982)){
(a[i_983] = reagent.impl.template.as_element.call(null,(a[i_983])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___985 = a.length;
var i_986 = (0);
while(true){
if((i_986 < n__4408__auto___985)){
var val_987 = (a[i_986]);
if(((cljs.core.vector_QMARK_.call(null,val_987)) && ((reagent.impl.template.key_from_vec.call(null,val_987) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_986] = reagent.impl.template.as_element.call(null,val_987));
...
var ctx = ({});
var vec__989 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__989,(0),null);
var derefed = cljs.core.nth.call(null,vec__989,(1),null);
...
var G__992 = (cljs.core.count.call(null,argv) - first_child);
switch (G__992) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__992){
