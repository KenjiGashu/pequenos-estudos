...
var G__23989 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__23989;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__23990 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23990,ch);
...
if(("\\" === ch__$1)){
var ch_23991__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_23991__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_23991__$2);
} else {
}
...
var vec__24000 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24000,(0),null);
var start_column = cljs.core.nth.call(null,vec__24000,(1),null);
...
var G__24003 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24003;
continue;
}
}
...
var _STAR_read_delim_STAR_24004 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24004;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24005 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__24008 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24008,(0),null);
var end_column = cljs.core.nth.call(null,vec__24008,(1),null);
...
var vec__24011 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__24014 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24014,(0),null);
var end_column = cljs.core.nth.call(null,vec__24014,(1),null);
...
var vec__24017 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24017,(0),null);
var start_column = cljs.core.nth.call(null,vec__24017,(1),null);
...
var vec__24020 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24020,(0),null);
var end_column = cljs.core.nth.call(null,vec__24020,(1),null);
...
var sb = (function (){var G__24023 = (new goog.string.StringBuffer());
G__24023.append(initch);
...
var G__24025 = (function (){var G__24024 = sb;
G__24024.append(ch);
...
switch (G__24029) {
case "\\":
var G__24033 = (function (){var G__24030 = sb;
G__24030.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24030;
})();
var G__24034 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24033;
ch = G__24034;
continue;
...
break;
default:
var G__24035 = (function (){var G__24031 = sb;
G__24031.append(ch);

return G__24031;
})();
var G__24036 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24035;
ch = G__24036;
continue;
...
var vec__24037 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24037,(0),null);
var end_column = cljs.core.nth.call(null,vec__24037,(1),null);
...
var vec__24040 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24040,(0),null);
var column = cljs.core.nth.call(null,vec__24040,(1),null);
...
var vec__24045 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24045,(0),null);
var column = cljs.core.nth.call(null,vec__24045,(1),null);
...
var vec__24050 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24050,(0),null);
var column = cljs.core.nth.call(null,vec__24050,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24055 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24055,(0),null);
var start_column = cljs.core.nth.call(null,vec__24055,(1),null);
...
var vec__24058 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24058,(0),null);
var end_column = cljs.core.nth.call(null,vec__24058,(1),null);
...
var G__24061 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24061,true,null,opts,pending_forms);
...
var G__24062 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24062)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24062)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24062)){
...
var _STAR_suppress_read_STAR_24063 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24063;
}});
...
var G__24064 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24064,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24064,rdr,first_line);
...
var G__24068 = matched;
var G__24069 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24068;
finished = G__24069;
continue;
} else {
...
var _STAR_suppress_read_STAR_24070 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24070;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24071 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24072 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24072,"(");
...
var G__24073 = (i + (1));
var G__24074 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24071;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24075 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24075);
...
var G__24076 = cljs.core.next.call(null,s__$1);
var G__24077 = ret;
s__$1 = G__24076;
r = G__24077;
continue;
...
var G__24078 = cljs.core.next.call(null,s);
var G__24079 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24078;
key_vals = G__24079;
continue;
} else {
...
var gensym_env24083 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24083;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24084 = token;
var G__24084__$1 = (((G__24084 == null))?null:cljs.core.subs.call(null,G__24084,(1)));
var G__24084__$2 = (((G__24084__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24084__$1));
var G__24084__$3 = (((G__24084__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24084__$2));
var G__24084__$4 = (((G__24084__$3 == null))?null:cljs.core.symbol.call(null,G__24084__$3));
if((G__24084__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24084__$4);
}
})():(function (){var G__24085 = token;
var G__24085__$1 = (((G__24085 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24085));
if((G__24085__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24085__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24096,reader){
...
var eof = cljs.core.get.call(null,map__24097__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24103){
var G__24104 = cljs.core.first.call(null,seq24103);
var seq24103__$1 = cljs.core.next.call(null,seq24103);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24104,seq24103__$1);
});


//# sourceMappingURL=reader.js.map?rel=1530909569168
