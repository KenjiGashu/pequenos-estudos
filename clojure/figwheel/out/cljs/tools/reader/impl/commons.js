...
var G__23957 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__23957;
continue;
} else {
return ch;
...
var vec__23958 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__23958,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq23961){
...
return (function() { 
var G__23966__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__23966 = function (rdr,var_args){
var _ = null;
...
while (G__23967__i < G__23967__a.length) {G__23967__a[G__23967__i] = arguments[G__23967__i + 1]; ++G__23967__i;}
  _ = new cljs.core.IndexedSeq(G__23967__a,0,null);
} 
return G__23966__delegate.call(this,rdr,_);};
G__23966.cljs$lang$maxFixedArity = 1;
G__23966.cljs$lang$applyTo = (function (arglist__23968){
var rdr = cljs.core.first(arglist__23968);
var _ = cljs.core.rest(arglist__23968);
return G__23966__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1530909568849
