...
return (new CustomEvent(event_name,(function (){var obj28640 = {"detail":data};
return obj28640;
})()));
} else {
...
var f = (function (){var pred__28647 = cljs.core._EQ_;
var expr__28648 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28647.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28648))){
return ((function (pred__28647,expr__28648){
return (function (p1__28641_SHARP_){
return console.warn(p1__28641_SHARP_);
});
;})(pred__28647,expr__28648))
} else {
if(cljs.core.truth_(pred__28647.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28648))){
return ((function (pred__28647,expr__28648){
return (function (p1__28642_SHARP_){
return console.debug(p1__28642_SHARP_);
});
;})(pred__28647,expr__28648))
} else {
if(cljs.core.truth_(pred__28647.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28648))){
return ((function (pred__28647,expr__28648){
return (function (p1__28643_SHARP_){
return console.error(p1__28643_SHARP_);
});
;})(pred__28647,expr__28648))
} else {
return ((function (pred__28647,expr__28648){
return (function (p1__28644_SHARP_){
return console.log(p1__28644_SHARP_);
});
;})(pred__28647,expr__28648))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28651){
...
var eval_fn = cljs.core.get.call(null,map__28652__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28654_SHARP_);
});})(new_def))
);
...
return (function (p__28655){
var vec__28656 = p__28655;
var ky = cljs.core.nth.call(null,vec__28656,(0),null);
...
if(cljs.core.truth_((function (){var and__3938__auto__ = (typeof localStorage !== 'undefined');
...
//# sourceMappingURL=utils.js.map?rel=1530909573392
